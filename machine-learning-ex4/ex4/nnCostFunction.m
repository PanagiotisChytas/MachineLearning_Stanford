...
%%Part 1
%for k = 1:num_labels
%  J +=  (-(y==k)'*log(h(:,k)) - (1-(y==k))'*log(1-h(:,k)))/m;
%endfor
%  
%%Part 3
...
%%Part 2
%
%D1 = zeros(num_labels, hidden_layer_size);
%D2 = zeros(hidden_layer_size, input_layer_size);
%
%for i = 1:m
%  
%  for k = 1:num_labels
...
%  endfor
%  
%  d2 = Theta2'*d3' .* sigmoidGradient((a*Theta2')(i, :));
%  
%  D1 += d2(2:end)*X(i, :)';
%  
%endfor
